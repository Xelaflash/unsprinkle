    ...
    <Wrapper>
      <picture>
        ...
        <source
          ...
          "
        />
        <HeroImage src="/images/hero-img.jpg"  alt="Example of image distributed by this website (cat staring at us on a black background)"/>
      </picture>
      {/* I set alt to empty because this is purely decorative svg img */}
